...
namespace conductivity_evaluators
{
    ...
    */
    ...
    public:
        SequentialHeatSimulation(int boardHeight, int boardWidth, int boardThickness, const SimulationParams &params = SimulationParams{}) : Simulation(boardHeight, boardWidth, boardThickness, params) {};
